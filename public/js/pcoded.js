...
for (var l = 0; l < elem.length; l++) {
    ...
    var elemHref = elem[l].href.split(/[?#]/)[0];

    if ((pageUrl === elemHref || pageUrl.startsWith(elemHref + '/')) && elem[l].getAttribute('href') != '') {
  ...
  if (layout == 'dark') {
    ...
    if (control) {
      ...
      if (document.querySelector('.auth-header')) {
        document.querySelector('.auth-header img').setAttribute('src', '~/images/logo-white.svg');
      }
    }
    ...
    if (control) {
      ...
      if (document.querySelector('.auth-header')) {
        document.querySelector('.auth-header img').setAttribute('src', '~/images/logo-dark.svg');
      }
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
